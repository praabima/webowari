...
<head>
    ...
    <title>Owari Official Store</title>
...
<body>
    ...
    <section class="hero">
        <div class="hero__slider owl-carousel">
            <div class="hero__items set-bg" data-setbg="{{ asset('frontend/img/hero/melo.jpg') }}">
                <div class="container">
                    <div class="row">
                        <div class="col-xl-5 col-lg-7 col-md-8">
                            <div class="hero__text">
                                <h6>MUSIC SERIES</h6>
                                <h2>Tshirts - Innocent Melody</h2>
                                <p>Design for you who like orchestral melodies with their innocent instruments</p>
            ...
            <div class="hero__items set-bg" data-setbg="{{ asset('frontend/img/hero/jus.jpg') }}">
                <div class="container">
                    <div class="row">
                        <div class="col-xl-5 col-lg-7 col-md-8">
                            <div class="hero__text">
                                <h6>MUSIC SERIES</h6>
                                <h2>JUICE WRLD EDITION</h2>
                                <p>Our design for you who loves him</p>
                                <a href="#" class="primary-btn">Shop now <span class="arrow_right"></span></a>
                                <div class="hero__social">
                                    <a href="#"><i class="fa fa-facebook"></i></a>
                                    <a href="#"><i class="fa fa-twitter"></i></a>
            ...
            <div class="row">
                <div class="col-lg-7 offset-lg-4">
                    <div class="banner__item">
                        <div class="banner__item__pic">
                            <img src="{{ asset('frontend/img/banner/tes.jpg') }}" alt="">
                        </div>
                        <div class="banner__item__text">
                            <h2>Tshirts Collection</h2>
                            <a href="#">Shop now</a>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-lg-7">
                    <div class="banner__item banner__item--last">
                        ...
                        <div class="banner__item__text">
                            <h2>Thumblr Bottle Collection</h2>
                            <a href="#">Shop now</a>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-lg-8">
                    <div class="instagram__pic">
                        <div class="instagram__pic__item set-bg"
                            data-setbg="{{ asset('frontend/img/instagram/instagram-1.jpg') }}"></div>
                        <div class="instagram__pic__item set-bg"
                            data-setbg="{{ asset('frontend/img/instagram/instagram-2.jpg') }}"></div>
                        <div class="instagram__pic__item set-bg"
                            data-setbg="{{ asset('frontend/img/instagram/instagram-3.jpg') }}"></div>
                        <div class="instagram__pic__item set-bg"
                            data-setbg="{{ asset('frontend/img/instagram/instagram-4.jpg') }}"></div>
                        <div class="instagram__pic__item set-bg"
                            data-setbg="{{ asset('frontend/img/instagram/instagram-5.jpg') }}"></div>
                        <div class="instagram__pic__item set-bg"
                            data-setbg="{{ asset('frontend/img/instagram/instagram-6.jpg') }}"></div>
                    </div>
                </div>
                <div class="col-lg-4">
                    <div class="instagram__text">
                        <h2>Instagram</h2>
                        <p>Find us at Instagram.</p>
                        <h3><a href="https://www.instagram.com/owari.cloth/?hl=id">@owari.cloth</a></h3>
                    </div>
                </div>
            </div>
        </div>
    ...
    <section class="latest spad">
        <div class="container">
            ...
            <div class="row">
                <div class="col-lg-4 col-md-6 col-sm-6">
                    <div class="blog__item">
                        ...
                        <div class="blog__item__text">
                            <span><img src="{{ asset('frontend/img/icon/calendar.png') }}" alt=""> 16
                                February 2020</span>
                ...
                <div class="col-lg-4 col-md-6 col-sm-6">
                    <div class="blog__item">
                        <div class="blog__item__pic set-bg" data-setbg="{{ asset('frontend/img/blog/blog-2.jpg') }}">
                        </div>
                        <div class="blog__item__text">
                            <span><img src="{{ asset('frontend/img/icon/calendar.png') }}" alt=""> 21
                                February 2020</span>
                ...
                <div class="col-lg-4 col-md-6 col-sm-6">
                    <div class="blog__item">
                        <div class="blog__item__pic set-bg" data-setbg="{{ asset('frontend/img/blog/blog-3.jpg') }}">
                        </div>
                        <div class="blog__item__text">
                            <span><img src="{{ asset('frontend/img/icon/calendar.png') }}" alt=""> 28
                                February 2020</span>
