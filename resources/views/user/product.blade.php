                ...
                <div class="col-lg-8">
                    <div class="blog__details__content">
                        ...
                        <div class="blog__details__text">
                            <p> Pada awalnya produk OWARI hanya satu jenis yaitu Tshirts. Namun sekarang OWARI telah menambahkan beberapa
                                jenis produk, total ada tiga jenis yaitu hoodie, totebag, dan thumblr bottle
                            </p>
                            <p> Penambahan produk berdasarkan riset kebutuhan dari para calon customer tentang jenis produk yang mereka pakai 
                        ...
                        <div class="blog__details__btns">
                            <div class="row">
                                ...
                                <div class="col-lg-6 col-md-6 col-sm-6">
                                    <a href="filosofi.html" class="blog__details__btns__item blog__details__btns__item--next">
